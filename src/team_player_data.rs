...
pub const CHRISTOPH: TeamMember = TeamMember{name: "Christoph", id:17};
pub const JACKY: TeamMember = TeamMember{name: "Jacky", id:18};
pub const PATRICK: TeamMember= TeamMember{name: "Patrick", id:19};
pub const MARCEL: TeamMember= TeamMember{name: "Marcel", id:20};
pub const JAN_W: TeamMember= TeamMember{name: "Jan W.", id:21};
pub const LENA: TeamMember= TeamMember{name: "Lena", id:22};
...
pub const TEAM_INVALID: Team = Team { name: "Illegal Team", id: 1000, member_1: PLAYER_INVALID, member_2: PLAYER_INVALID };
pub const DA_HAM_SIE: Team = Team { name: "Da ham sie einfach gewonnen", id: 1001, member_1: JEROME, member_2: BEEF };
pub const DOS_BROS: Team = Team { name: "Dos Bros", id: 1002, member_1: SEBI, member_2: FLO };
pub const STRAMMSEIN: Team = Team { name: "Strammsein", id: 1003, member_1: JONAS, member_2: SASCHA };
pub const WHITE_CLAW: Team = Team { name: "White Claw", id: 1004, member_1: LUISE, member_2: TOBIAS };
pub const WEDELMEDEL: Team = Team { name: "Team Wädelmädel", id: 1005, member_1: MALTE, member_2: CHRIS };
pub const GEWERTET: Team = Team { name: "Wurde das gewertet?", id: 1006, member_1: HANNES, member_2: LAURA };
pub const TOBÖNKE: Team = Team { name: "Prinzessin Tobönke", id: 1007, member_1: TOBIAS, member_2: SÖNKE };
pub const CHROME: Team = Team { name: "Chrome", id: 1008, member_1: JEROME, member_2: CHRIS };
pub const BIERATENPARTEI: Team = Team { name: "Bieratenpartei", id: 1009, member_1: SEBI, member_2: BEEF };
pub const LURCHIE: Team = Team { name: "Lurchie", id: 1010, member_1: LUISE, member_2: MICHI };
pub const NAME_KOMMT_SPÄTER: Team = Team { name: "Name kommt später", id: 1011, member_1: SARA, member_2: KATHI };
pub const MINDESTGRÖSSE: Team = Team { name: "#Mindestgröße", id: 1012, member_1: JONAS, member_2: HANNES };
pub const MC_FLANKY: Team = Team { name: "Mc Flankygeil", id: 1013, member_1: JACKY, member_2: MARCEL };
pub const FLANKY_KRIEG: Team = Team { name: "Flankyball ist Krieg", id: 1014, member_1: PATRICK, member_2: CHRISTOPH };
pub const RESERVISTEN: Team = Team { name: "Reservisten", id: 1015, member_1: TOBIAS, member_2: JAN_W };
pub const PAEDAGOGISCH: Team = Team { name: "Pädagogisch wertvoll", id: 1016, member_1: LUISE, member_2: LENA };
