...
pub const CHRIS_SINGLE_01: TeamMember = TeamMember::create("Chris Alone1", 45);
pub const CHRIS_SINGLE_02: TeamMember = TeamMember::create("Chris Alone2", 46);
pub const SOENKE_SINGLE_01: TeamMember = TeamMember::create("Sönke Alone1", 47);
pub const SOENKE_SINGLE_02: TeamMember = TeamMember::create("Sönke Alone2", 48);
...
pub const DER_WEDELMEDL:Team=Team::create("Der Wedelmedel", 1029, CHRIS_SINGLE_01, CHRIS_SINGLE_02);
pub const NATÜRLICH_BLOND:Team=Team::create("Naturlich Blond", 1030, LUISE, SEBI);
pub const ESSIN_ÖNKE:Team=Team::create("essin önke", 1031, SOENKE_SINGLE_01, SOENKE_SINGLE_02);
pub const DER_SCHÖNE:Team=Team::create("Der Schöne und das Beef", 1032, BEEF, TOBIAS);
