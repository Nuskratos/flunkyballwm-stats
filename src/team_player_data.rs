...
pub const MC_FLANKY: Team = Team { name: "Mc Flankygeil", id: 113, member_1: JACKY, member_2: MARCEL };
pub const FLANKY_KRIEG: Team = Team { name: "Flankyball ist Krieg", id: 114, member_1: PATRICK, member_2: CHRISTOPH };
pub const RESERVISTEN: Team = Team { name: "Reservisten", id: 115, member_1: TOBIAS, member_2: JAN_W };
pub const PAEDAGOGISCH: Team = Team { name: "Pädagogisch wertvoll", id: 116, member_1: LUISE, member_2: LENA };
