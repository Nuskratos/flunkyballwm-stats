...
pub fn game_10(left_team: Team, left_1: TeamMember, left_2: TeamMember, right_team: Team, right_1: TeamMember, right_2: TeamMember) -> Game {
    ...
    Game { result, match_number: 10, left_team, left_1, left_2, right_team, right_1, right_2, rounds, special_first_throw: None , won_rps_but_decided_to_run: false }
}
...
pub fn game_7(left_team: Team, left_1: TeamMember, left_2: TeamMember, right_team: Team, right_1: TeamMember, right_2: TeamMember) -> Game {
    ...
    Game { result, match_number: 7, left_team, left_1, left_2, right_team, right_1, right_2, rounds, special_first_throw: None , won_rps_but_decided_to_run: false }
}
pub fn game_6(left_team: Team, left_1: TeamMember, left_2: TeamMember, right_team: Team, right_1: TeamMember, right_2: TeamMember) -> Game {
    ...
    Game { result, match_number: 6, left_team, left_1, left_2, right_team, right_1, right_2, rounds, special_first_throw: None , won_rps_but_decided_to_run: false }
}
pub fn game_5(left_team: Team, left_1: TeamMember, left_2: TeamMember, right_team: Team, right_1: TeamMember, right_2: TeamMember) -> Game {
    ...
    Game { result, match_number: 5, left_team, left_1, left_2, right_team, right_1, right_2, rounds, special_first_throw: None , won_rps_but_decided_to_run: false }
}
pub fn game_4(left_team: Team, left_1: TeamMember, left_2: TeamMember, right_team: Team, right_1: TeamMember, right_2: TeamMember) -> Game {
    ...
    Game { result, match_number: 4, left_team, left_1, left_2, right_team, right_1, right_2, rounds, special_first_throw: None , won_rps_but_decided_to_run: false }
}
pub fn game_3(left_team: Team, left_1: TeamMember, left_2: TeamMember, right_team: Team, right_1: TeamMember, right_2: TeamMember) -> Game {
    ...
    Game { result, match_number: 3, left_team, left_1, left_2, right_team, right_1, right_2, rounds, special_first_throw: None , won_rps_but_decided_to_run: false }
}
pub fn game_2(left_team: Team, left_1: TeamMember, left_2: TeamMember, right_team: Team, right_1: TeamMember, right_2: TeamMember) -> Game {
    ...
    Game { result, match_number: 2, left_team, left_1, left_2, right_team, right_1, right_2, rounds, special_first_throw: None , won_rps_but_decided_to_run: false }
}
...
pub fn game_1(left_team: Team, left_1: TeamMember, left_2: TeamMember, right_team: Team, right_1: TeamMember, right_2: TeamMember) -> Game {
    ...
    Game { result, match_number: 1, left_team, left_1, left_2, right_team, right_1, right_2, rounds, special_first_throw: None , won_rps_but_decided_to_run: false }
}
